...
namespace Aurora {
	void VulkanPipeline::Init(VkDevice device, VkRenderPass renderPass) {
	...
	VkShaderModule VulkanPipeline::CreateShaderModule(const std::vector<char>& code, VkDevice device) const {
		...
		if (vkCreateShaderModule(device, &createInfo, nullptr, &shaderModule) != VK_SUCCESS) {
			AU_CORE_CRITICAL("Failed to create shader module\n");
		}
