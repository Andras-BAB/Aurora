...
- [ ] Lot of rendering changes e.g. frustum culling, multiple global buffers (position only for shadow pass), drawl call reordering for materials, better GPU heap usage with descriptor tables (and for bindless textures) instead of root constants for objects
